...
{"Classification", &DMWRITE, os_addObjQoSClassification, os_delObjQoSClassification, NULL, os_browseQoSClassificationInst, NULL, NULL, NULL, NULL, tQoSClassificationParams, NULL, BBFDM_BOTH, LIST_KEY{"Alias", NULL}},
{"QueueStats", &DMWRITE, os_addObjQoSQueueStats, os_delObjQoSQueueStats, NULL, os_browseQoSQueueStatsInst, NULL, NULL, NULL, NULL, tQoSQueueStatsParams, NULL, BBFDM_BOTH, LIST_KEY{"Alias", "Queue", "Interface", NULL}},
//{"App", &DMWRITE, addObjQoSApp, delObjQoSApp, NULL, browseQoSAppInst, NULL, NULL, NULL, NULL, tQoSAppParams, NULL, BBFDM_BOTH, LIST_KEY{"Alias", NULL}},
//{"Flow", &DMWRITE, addObjQoSFlow, delObjQoSFlow, NULL, browseQoSFlowInst, NULL, NULL, NULL, NULL, tQoSFlowParams, NULL, BBFDM_BOTH, LIST_KEY{"Alias", NULL}},
{"Policer", &DMWRITE, os_addObjQoSPolicer, os_delObjQoSPolicer, NULL, os_browseQoSPolicerInst, NULL, NULL, NULL, NULL, tQoSPolicerParams, NULL, BBFDM_BOTH, LIST_KEY{"Alias", NULL}},
{"Queue", &DMWRITE, os_addObjQoSQueue, os_delObjQoSQueue, NULL, os_browseQoSQueueInst, NULL, NULL, NULL, NULL, tQoSQueueParams, os_get_linker_qos_queue, BBFDM_BOTH, LIST_KEY{"Alias", NULL}},
{"Shaper", &DMWRITE, os_addObjQoSShaper, os_delObjQoSShaper, NULL, os_browseQoSShaperInst, NULL, NULL, NULL, NULL, tQoSShaperParams, NULL, BBFDM_BOTH, LIST_KEY{"Interface", "Alias", NULL}},
{0}
};
...
/* PARAM, permission, type, getvalue, setvalue, forced_inform, notification, bbfdm_type*/
{"Enable", &DMWRITE, DMT_BOOL, os_get_QoSClassification_Enable, os_set_QoSClassification_Enable, NULL, NULL, BBFDM_BOTH},
...
{"DestMask", &DMWRITE, DMT_STRING, os_get_QoSClassification_DestMask, os_set_QoSClassification_DestMask, NULL, NULL, BBFDM_BOTH},
...
{"SourceMask", &DMWRITE, DMT_STRING, os_get_QoSClassification_SourceMask, os_set_QoSClassification_SourceMask, NULL, NULL, BBFDM_BOTH},
...
{"SourcePortRangeMax", &DMWRITE, DMT_INT, os_get_QoSClassification_SourcePortRangeMax, os_set_QoSClassification_SourcePortRangeMax, NULL, NULL, BBFDM_BOTH},
...
{"SourceMACAddress", &DMWRITE, DMT_STRING, os_get_QoSClassification_SourceMACAddress, os_set_QoSClassification_SourceMACAddress, NULL, NULL, BBFDM_BOTH},
...
{"DestMACAddress", &DMWRITE, DMT_STRING, os_get_QoSClassification_DestMACAddress, os_set_QoSClassification_DestMACAddress, NULL, NULL, BBFDM_BOTH},
...
{"Ethertype", &DMWRITE, DMT_INT, os_get_QoSClassification_Ethertype, os_set_QoSClassification_Ethertype, NULL, NULL, BBFDM_BOTH},
...
{"IPLengthMin", &DMWRITE, DMT_UNINT, os_get_QoSClassification_IPLengthMin, os_set_QoSClassification_IPLengthMin, NULL, NULL, BBFDM_BOTH},
{"IPLengthMax", &DMWRITE, DMT_UNINT, os_get_QoSClassification_IPLengthMax, os_set_QoSClassification_IPLengthMax, NULL, NULL, BBFDM_BOTH},
...
{"DSCPCheck", &DMWRITE, DMT_INT, os_get_QoSClassification_DSCPCheck, os_set_QoSClassification_DSCPCheck, NULL, NULL, BBFDM_BOTH},
//{"DSCPExclude", &DMWRITE, DMT_BOOL, get_QoSClassification_DSCPExclude, set_QoSClassification_DSCPExclude, NULL, NULL, BBFDM_BOTH},
{"DSCPMark", &DMWRITE, DMT_INT, os_get_QoSClassification_DSCPMark, os_set_QoSClassification_DSCPMark, NULL, NULL, BBFDM_BOTH},
{"EthernetPriorityCheck", &DMWRITE, DMT_INT, os_get_QoSClassification_EthernetPriorityCheck, os_set_QoSClassification_EthernetPriorityCheck, NULL, NULL, BBFDM_BOTH},
...
{"VLANIDCheck", &DMWRITE, DMT_INT, os_get_QoSClassification_VLANIDCheck, os_set_QoSClassification_VLANIDCheck, NULL, NULL, BBFDM_BOTH},

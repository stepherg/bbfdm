...
The following [link](https://dev.iopsys.eu/iopsys/bbf/-/blob/devel/libbbf_dm/src/dmtree/vendor/test/tr181/vendor.c) contains example of Extend, Overwrite and Exclude table.
...
Example: [Custom Vendor Object Dropbear](https://dev.iopsys.eu/iopsys/bbf/-/blob/devel/libbbf_dm/src/dmtree/vendor/test/tr181/x_test_com_dropbear.c)
...
Example: [Link vendor tables to the main tree](https://dev.iopsys.eu/iopsys/bbf/-/blob/devel/libbbf_dm/src/dmtree/vendor/vendor.c)

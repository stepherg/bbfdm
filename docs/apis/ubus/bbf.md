...
```
ubus call bbf add {"path":"eiusmod Duis","optional":{"transaction_id":96375366},"obj_path":{}}
```
...
```json
{
  ...
  "params": [
    ...
    "bbf",
    "add",
    { "path": "eiusmod Duis", "optional": { "transaction_id": 96375366 }, "obj_path": {} }
  ]
}
```
...
```json
{
  "results": [
    {
      "path": "laboris nisi pariatur ut cupidatat",
      "data": "ex mollit",
      "fault": 7775,
      "fault_msg": "tempor ipsum Duis"
    }
  ]
}
```
...
```
ubus call bbf del {"path":"pariatur Duis ve","paths":["mollit commodo"],"optional":{"transaction_id":62908627}}
```
...
```json
{
  ...
  "params": [
    ...
    "bbf",
    "del",
    { "path": "pariatur Duis ve", "paths": ["mollit commodo"], "optional": { "transaction_id": 62908627 } }
  ]
}
```
...
```json
{ "results": [{ "path": "fugiat", "data": "laborum", "fault": 8825, "fault_msg": "proident do officia amet in" }] }
```
...
```
ubus call bbf get {"path":"amet magna","paths":["adipisicing do"],"maxdepth":24914425,"optional":{"format":"pretty","proto":"usp","instance_mode":0}}
```
...
```json
{
  ...
  "params": [
    ...
    {
      "path": "amet magna",
      "paths": ["adipisicing do"],
      "maxdepth": 24914425,
      "optional": { "format": "pretty", "proto": "usp", "instance_mode": 0 }
    }
  ]
}
```
...
{
  "results": [
    { "path": "estDuis", "data": "consectetur", "type": "xsd:unsignedLong", "fault": 7902, "fault_msg": "aliquip" }
  ]
}
```
...
```
ubus call bbf instances {"path":"et qui ","first_level":false,"optional":{"proto":"cwmp","instance_mode":0}}
```
...
```json
{
  ...
  "params": [
    ...
    "bbf",
    "instances",
    { "path": "et qui ", "first_level": false, "optional": { "proto": "cwmp", "instance_mode": 0 } }
  ]
}
```
...
```json
{ "results": [{ "path": "exconsectetur", "fault": 7078, "fault_msg": "fugiat anim occaecat do aliquip" }] }
```
...
```
ubus call bbf notify_event {"name":"conse","input":{}}
```
...
```json
{
  ...
  "id": 0,
  "method": "call",
  "params": ["<SID>", "bbf", "notify_event", { "name": "conse", "input": {} }]
}
```
...
```json
{
  "definitions": {
    ...
    "format_t": { "type": "string", "enum": ["raw", "pretty"] },
    "instance_mode_t": { "type": "integer", "minimum": 0, "maximum": 1 },
...
```
ubus call bbf operate {"command":"amet nisi eu deserunt magna","command_key":"aute fugiat labori","input":{},"optional":{"format":"pretty","proto":"both","instance_mode":0}}
```
...
```json
{
  ...
  "params": [
    ...
    "operate",
    {
      "command": "amet nisi eu deserunt magna",
      "command_key": "aute fugiat labori",
      "input": {},
  ...
  "results": [
    {
      ...
      "data": "1",
      "fault": 8668,
      "fault_msg": "tempor incididunt et",
      "output": [{ "path": "cillum laborum sit", "data": "1", "type": "xsd:object" }]
    }
  ]
}
```
...
```
ubus call bbf schema {"path":"Excepteur est do eiusmod","paths":["sedincididunt"],"first_level":true,"commands":false,"events":true,"params":false,"optional":{"proto":"cwmp"}}
```
  ...
  "results": [
    {
      ...
      "type": "xsd:boolean",
      "fault": 8243,
      "fault_msg": "ullamco fugiat amet in",
      "input": [{ "path": "sunt amet occaec", "data": "0", "type": "xsd:unsignedLong" }],
      "output": [{ "path": "officia", "data": "0", "type": "xsd:long" }]
    }
  ]
}
```
...
```
ubus call bbf set {"path":"dolore","value":"aute sed Duis","optional":{"proto":"both","instance_mode":0,"transaction_id":42436744},"obj_path":{}}
```
...
```json
{
  ...
  "params": [
    ...
    "set",
    {
      "path": "dolore",
      "value": "aute sed Duis",
      "optional": { "proto": "both", "instance_mode": 0, "transaction_id": 42436744 },
      "obj_path": {}
    }
  ]
}
...
{
  "results": [
    { "path": "voluptate laboris eu", "data": "1", "fault": 8965, "fault_msg": "adipisicing do sit officia" }
  ]
}
```
...
```
ubus call bbf transaction {"cmd":"abort","timeout":44768342,"restart_services":true,"optional":{"transaction_id":37432876}}
```
...
```json
{
  ...
  "params": [
    ...
    "bbf",
    "transaction",
    { "cmd": "abort", "timeout": 44768342, "restart_services": true, "optional": { "transaction_id": 37432876 } }
  ]
}
```
...
```json
{ "status": true, "transaction_id": 38008651, "error": "cupidatat" }
```

...
def generatelistfromfile(dmobject):
    ...
    if "tr-104" in sys.argv[1]:
        pathfilename = "../libbbf_dm/src/dmtree/tr104/" + obj[1].lower() + ".c"
        pathiopsyswrtfilename = "../libbbf_dm/src/dmtree/tr104/" + \
            obj[1].lower() + "-iopsyswrt.c"
    else:
        pathfilename = "../libbbf_dm/src/dmtree/tr181/" + obj[1].lower() + ".c"
        pathiopsyswrtfilename = "../libbbf_dm/src/dmtree/tr181/" + \
            obj[1].lower() + "-iopsyswrt.c"
